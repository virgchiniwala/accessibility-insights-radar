     ...
     alt="Infographic showing 85% of citizens now use digital government services">`}</code>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-border p-4 shadow-lg">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            <div>
              <div className="font-semibold">Ready to fix this issue?</div>
              <div className="text-sm text-muted-foreground">Export to your development workflow or share with your team</div>
            </div>
