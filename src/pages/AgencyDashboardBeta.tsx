...
import { Users, Award, TrendingUp, Mail, Clock } from "lucide-react";
...
export default function AgencyDashboardBeta() {
  ...
  const lowEngagementAgencies = agencies.filter(agency => agency.scansRun < 5);

  const handleInviteAgencies = () => {
    const now = new Date();
          ...
          <div className="flex justify-between items-start">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <h1 className="text-4xl font-heading font-normal">Agency Dashboard</h1>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {filteredAgencies.map((agency, index) => (
                    <div 
                      key={agency.name} 
                      className="grid grid-cols-6 gap-4 p-3 rounded-lg hover:bg-surface/50 transition-colors cursor-pointer"
                      onClick={() => {
                        // Agency detail navigation would go here
                        console.log(`Navigate to ${agency.name} detail`);
                      }}
                    >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-orange-700 mb-4">
                    {lowEngagementAgencies.length} agencies have run fewer than 5 scans: {lowEngagementAgencies.map(a => a.name).join(", ")}. 
                  ...
                  {invitationSent ? (
                    <div className="flex items-center gap-2 text-green-700 font-medium">
                      ...
                      Invitation sent {invitationTime}
                    </div>
                  ) : (
                    <Button 
                      variant="secondary" 
                      className="bg-white hover:bg-orange-50 border-orange-200"
                      onClick={handleInviteAgencies}
                    >
